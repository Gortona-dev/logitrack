...
import com.gortona.logitrack.service.DashboardService;
...
public class DashboardController {
	...
	public ResponseEntity<ApiResponse<DashboardResponse>> getOverview() {
		DashboardResponse response = dashboardService.getOverview();
		return ResponseEntity.ok(ApiResponse.success("Dashboard consultado com sucesso", response));
	}
}
